...
#SBATCH --job-name=brats_real_vs_gen
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --partition=P2
...
echo "Validation MAISI BraTS real_vs_gen"

python3 alleval_brats.py \
    --pretrained_vae_path /shared/s1/lab06/wonyoung/maisi/weights/brats/brats_vae_stage2 \
    --pretrained_unet_path /leelabsg/data/ex_MAISI/maisi_brats/models/checkpoint-100000 \
