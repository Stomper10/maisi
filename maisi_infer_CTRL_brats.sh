...
echo "MAISI CTRL inference."

export JOB_NAME="E0_BraTS_temp"
#export JOB_NAME=$SLURM_JOB_NAME

python3 /shared/s1/lab06/wonyoung/maisi/maisi_infer_CTRL_brats.py \
    --env_config="/leelabsg/data/ex_MAISI/$JOB_NAME/environment_maisi_controlnet_train.json" \
    --train_config="/leelabsg/data/ex_MAISI/$JOB_NAME/config_maisi_controlnet_train.json" \
