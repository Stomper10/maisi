...
echo "Training MAISI brats UNET from scratch."

export JOB_NAME=$SLURM_JOB_NAME

python3 /shared/s1/lab06/wonyoung/maisi/maisi_train_UNET_brats.py \
    --env_config="/leelabsg/data/ex_MAISI/$JOB_NAME/environment_maisi_diff_model.json" \
    --model_config="/leelabsg/data/ex_MAISI/$JOB_NAME/config_maisi_diff_model.json" \
